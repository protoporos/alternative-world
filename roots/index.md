...
This is a list of nodes for an alternative world: (great resources are **bold**). This list is seperated in:
Tools, Information, Network/Connect
...
- [Technology for development](https://www.wot.utwente.nl/en/knowledge-center/library): a libary
...
- [Working Group on Development Techniques (WOT)](https://www.wot.utwente.nl/en/demonstration-site): developing technology for use in developing countries
...
## FOOD PRODUCTION
MAPS
- [**World**] [fallingfruit.org](https://fallingfruit.org/): maaping fruit trees and shrubs
...
## ELECTRONICS
- [ifixit](https://www.ifixit.com/): a repare forum for all kinds of tech
...
## RECYCLING & REPAIRING
- [preciousplastics community platform](https://community.preciousplastic.com/how-to): working with plastics and share what you learn
- [fixing.fashion](https://fixing.fashion/): an introduction to fixing / repairing your clothing
...
- [couchsurfing.com](https://www.couchsurfing.com/): host and sleep on couches
- [warmshowers.org](https://.warmshowers.org/): only when you're on a biketrip and look for a place to spend the night
...
- [**Germany**] [gutundboesel.org](https://www.gutundboesel.org/): exploring different kinds of multi-functional land-use.
...
- [**Germany**] [reparatur-initiativen.de](https://www.reparatur-initiativen.de/reparatur-termine): repair cafés

## Online Communities concerned with climate change
